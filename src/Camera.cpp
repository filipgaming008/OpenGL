...
void Camera::MouseUpdate(glm::vec2 &mousePos, double m_deltaTime){
    glm::vec2 delta = mousePos - lastMousePos;
    delta *= sensitivity * (float)m_deltaTime;
...
void Camera::PositionUpdate(enum CameraMovement direction, double m_deltaTime){
    float velocity = speed * (float)m_deltaTime;
    switch (direction){
